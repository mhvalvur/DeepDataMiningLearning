...
from detection.myevaluator import simplemodelevaluate, modelevaluate, yoloevaluate
...
def get_args_parser(add_help=True):
    ...
    parser.add_argument("--expname", default="0319", help="experiment name, create a sub-folder")
